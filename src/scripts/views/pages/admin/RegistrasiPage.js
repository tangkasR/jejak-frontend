...
const RegistrasiPage = {
  async render () {
    return `
    <div class="mt-4 d-flex flex-column align-items-center justify-content-center w-100 mb-5" style="min-height: 60vh;">
        <div class="mt-3 card shadow p-4" style="width: 50%;">
            ...
            <form class="registrasiform">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <p class="mt-4">Anda sudah mempunyai akun? <a href="#/login"> klik disini </a></p>
                </div>
            </form>
        </div>
    </div>
